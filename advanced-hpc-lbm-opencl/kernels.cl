...
/* compute x velocity component */
  ...
  barrier(CLK_LOCAL_MEM_FENCE);
    ...
    /* relaxation step */
  tmp_cells[index + (0 * totalSize)]  = obstacles[index] ? speed  : (speed + omega * (d_equ - speed));
  tmp_cells[index + (1 * totalSize)] = obstacles[index] ? speed3 : (speed1 + omega * (d_equ1 - speed1));
  tmp_cells[index + (2 * totalSize)] = obstacles[index] ? speed4 : (speed2 + omega * (d_equ2 - speed2));
  tmp_cells[index + (3 * totalSize)] = obstacles[index] ? speed1 : (speed3 + omega * (d_equ3 - speed3));
  tmp_cells[index + (4 * totalSize)] = obstacles[index] ? speed2 : (speed4 + omega * (d_equ4 - speed4));
  tmp_cells[index + (5 * totalSize)] = obstacles[index] ? speed7 : (speed5 + omega * (d_equ5 - speed5));
  tmp_cells[index + (6 * totalSize)] = obstacles[index] ? speed8 : (speed6 + omega * (d_equ6 - speed6));
  tmp_cells[index + (7 * totalSize)] = obstacles[index] ? speed5 : (speed7 + omega * (d_equ7 - speed7));
  tmp_cells[index + (8 * totalSize)] = obstacles[index] ? speed6 : (speed8 + omega * (d_equ8 - speed8));
  // if (!isnan(tmp_cells[index + (0 * totalSize)]) && cells[index + (0 * totalSize)] != 0) {
  //   printf("%f %f %f %f %f %f %f %f %f\n", tmp_cells[index + (0 * totalSize)], tmp_cells[index + (1 * totalSize)],
  //                                          tmp_cells[index + (2 * totalSize)], tmp_cells[index + (3 * totalSize)], 
  //                                          tmp_cells[index + (4 * totalSize)], tmp_cells[index + (5 * totalSize)], 
  //                                          tmp_cells[index + (6 * totalSize)], tmp_cells[index + (7 * totalSize)], 
  //                                          tmp_cells[index + (8 * totalSize)]);
  // }
